...
- BP3.4.1 — Quarterly Cash Formula Reconciliation — **Complete (parity + idempotency verified); supersession self-reference pending reconciliation** (see `docs/commercial/bp3-4-test-evidence.md`). Corrected cash runs: CONS `2aaab721…`, BASE `521cf9e1…`, UPSIDE `44eab7db…` — each carries `formula_version=bp3.4.1`, 152 inputs / 55 results. Base FY2027 quarterly cash + WC parity to golden = 0.00 variance (Q1 $712,538.92; Q2–Q4 $607,538.92; Q2 cum NCF and WC trough −$1,020,077.83; max funding $1,020,077.83). Conservative and Upside corrected quarters recomputed. Idempotency verified — second execution returned `0 new · 3 reused`. Defective runs (`e79ba517…`, `d225ea9f…`, `93f33caf…`) preserved and `status='superseded'` (not current). Remaining: defective `supersedes_run_id` still points to self and corrected runs' `supersedes_run_id` is NULL — data-only supersession reconciliation required before BP3.4.VALIDATE. Revenue and P&L runs unchanged (fingerprints untouched).
