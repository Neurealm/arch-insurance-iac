...
export default tseslint.config(
  ...
  {
    // Lovable regenerates this file on every deploy -- its first line reads
    // "This file is automatically generated. Do not edit it directly." A
    // prefer-const fix was committed here twice and reverted by a Lovable push
    // both times, turning App validation red each round. Style rules are
    // relaxed for generated sources rather than fought over; correctness rules
    // still apply in full.
