...
REVOKE ALL ON FUNCTION public.admin_get_user_login_history(uuid, text, int) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.admin_get_user_login_history(uuid, text, int) TO authenticated, service_role;
