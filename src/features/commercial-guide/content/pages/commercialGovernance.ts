...
export const commercialGovernanceGuide: CommercialGuideContent = {
  ...
  confidenceBasis: ["Governance approvals", "Timing", "Commercial terms", "Source completeness"],
  confidenceGuidance:
    "Confidence is high on the governance structure itself — tiers, decision rights, forums, chairs, cadence and RACI are all explicitly defined. It is lower on operating performance: this page is a prototype whose state is local and unpersisted, gate progression is evidenced only by activity checklists, and decision evidence is free-text without attachments or signatures. Treat structure as authoritative and status as indicative until items are confirmed with their owners.",
  commercialReadiness: "Approval Required",
  readinessCriteria: [
    "Every open risk and decision has a named owner and an explicit due date.",
    "Each open item is routed to a forum with the authority to close it.",
    "High risks carry a live mitigation with an owner and a date.",
    "Phase readiness claims are supported by the completed activity checklist.",
    "Commercial approvals follow the Commercial Governance Council to Executive Steering Committee path.",
    "Decisions carry recorded rationale and stated impact before being marked Approved.",
    "Downstream Commercial Module pages have been updated to reflect approved decisions.",
  ],

  /* ---------------- How to use it ---------------- */
  workflow: [
    { id: "wf-1", step: 1, title: "Review governance health", description: "Read the five summary cards and check them against the open registers rather than accepting the headline percentage.", role: "Program Director" },
    { id: "wf-2", step: 2, title: "Review upcoming forums", description: "Read the calendar from June 17 to June 26 and note which forum can close each open item.", role: "PMO" },
    { id: "wf-3", step: 3, title: "Review overdue actions", description: "Check open actions per forum and per tier, and read Action Closure On Time and Decisions Made On Time.", role: "PMO" },
    { id: "wf-4", step: 4, title: "Review high risks", description: "Open each High risk, confirm severity, impact, mitigation and status are current.", role: "PMO" },
    { id: "wf-5", step: 5, title: "Review open decisions", description: "Read the decision register for status, forum and impact, focusing on Attention Required and In Progress items.", role: "Program Director" },
    { id: "wf-6", step: 6, title: "Confirm owners and due dates", description: "Every open item must carry a named owner and a dated deadline before the cycle closes.", role: "PMO" },
    { id: "wf-7", step: 7, title: "Route items to the correct forum", description: "Match the item to the tier with the authority to decide it; do not route an executive approval to a program forum.", role: "Program Director" },
    { id: "wf-8", step: 8, title: "Record the decision and rationale", description: "Move the status and write the rationale or outcome in the decision drawer at the moment of decision.", role: "Decision owner" },
    { id: "wf-9", step: 9, title: "Update impacted Commercial Module pages", description: "Apply approved assumption changes, staffing decisions and release decisions on the pages that own them.", role: "Commercial Lead" },
    { id: "wf-10", step: 10, title: "Confirm gate status", description: "Read Day 0, Day 1 and Day 2 readiness and check the completed activities behind the percentage.", role: "Transition Lead" },
    { id: "wf-11", step: 11, title: "Prepare the executive update", description: "Use the executive attention panel and the composed update covering open risks, open decisions, Day 0 readiness and forum open actions.", role: "Program Director" },
    { id: "wf-12", step: 12, title: "Retain evidence", description: "Keep mitigation notes, rationale, impact and the activity log so closed items remain defensible.", role: "PMO" },
  ],
  actionsAvailable: [
    "Switch the governance view and read the executive perspective.",
    "Select a summary card to jump to the section it summarises.",
    "Open a tier, forum, risk, decision, phase or meeting drawer for full detail.",
    "Add, edit, note, close or escalate a risk in the register.",
    "Add, edit, approve or escalate a decision in the register.",
    "Tick a phase activity and see readiness recalculate.",
    "Add a forum action item or draft a meeting request.",
    "Add a meeting agenda item or draft a reschedule.",
    "Update a KPI value or status.",
    "Copy the executive update to the clipboard, or export (prototype only).",
    "Reset the page to the initial mock governance data.",
  ],
  teamActivities: [
    { id: "ta-1", activity: "Chair the Executive Steering Committee and close Tier 1 decisions", role: "Executive Sponsor", cadence: "Monthly" },
    { id: "ta-2", activity: "Run the PMO forum and maintain the integrated plan", role: "Program Director", cadence: "Weekly" },
    { id: "ta-3", activity: "Maintain the risk, issue, decision and action registers", role: "PMO", cadence: "Weekly" },
    { id: "ta-4", activity: "Chair the Commercial Governance Council and review assumption change sets", role: "Commercial Lead", cadence: "Biweekly" },
    { id: "ta-5", activity: "Review operational health, incidents and automation adoption", role: "RunOps Lead", cadence: "Weekly" },
    { id: "ta-6", activity: "Review change queue and release readiness", role: "Change Manager", cadence: "Weekly" },
    { id: "ta-7", activity: "Confirm phase readiness and transition gate evidence", role: "Transition Lead", cadence: "Weekly" },
    { id: "ta-8", activity: "Review customer health, adoption and value realization", role: "Customer Success Lead", cadence: "Monthly" },
  ],
  roles: [
