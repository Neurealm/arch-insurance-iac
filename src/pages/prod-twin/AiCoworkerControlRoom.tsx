...
const ACTIONS: Array<{ id: string; title: string; coworker: string; level: string; target: string; risk: Risk; created: string; status: string; statusTone: string; owner: string; }> = [
  ...
  { id: "a4", title: "Generate rollback plan for IDD release",   coworker: "Runbook Composer",           level: "L2 Prepare",     target: "IDD Release 2026.5.1", risk: "medium", created: "May 14, 07:01", status: "Prepared",    statusTone: "bg-violet-50 text-violet-700 border-violet-200",   owner: "Release Eng" },
