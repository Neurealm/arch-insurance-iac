...
import img from "@/assets/euc-dashboard.png";
    ...
    <AppShell>
        ...
        <div className="px-8 pt-5 pb-4 flex items-start gap-6">
          <div className="flex-1 min-w-0">
            ...
            <h1 className="text-[24px] font-bold tracking-tight text-foreground leading-tight">
              EUC Provisioning Coworker — <span className="text-slate-700">Operational Dashboard</span>
            </h1>
            <p className="text-sm text-muted-foreground mt-0.5">
              Live program status, KPIs, readiness, top issues, journey milestones, and actions required.
            </p>
          </div>
          <div className="flex items-center gap-2 shrink-0 mt-1">
            ...
            <Button onClick={() => nav("/coworkers/it-carve-out-and-separation/euc/solution-design")} className="h-10 px-4 font-semibold bg-navy hover:bg-navy/90 text-white">
      ...
      <main className="flex-1 px-8 py-6 animate-fade-in">
        <div className="rounded-xl border border-border bg-card shadow-[var(--shadow-sm)] overflow-hidden">
          <img src={img} alt="EUC Provisioning Coworker — Operational Dashboard" className="w-full h-auto block" />
        </div>
      </main>
    </AppShell>
  );
