...
import img from "@/assets/cmm-solution-design.png";

export default function CmmSolutionDesign() {
    ...
    <AppShell>
        ...
        <div className="px-8 pt-5 pb-4 flex items-start gap-6">
          <div className="flex-1 min-w-0">
            ...
            <h1 className="text-[24px] font-bold tracking-tight text-foreground leading-tight">
              Cloud Migration & Modernization Coworker — <span className="text-slate-700">Solution Design</span>
            </h1>
            <p className="text-sm text-muted-foreground mt-0.5">
              A comprehensive solution design for efficient cloud migration and modernization at global scale.
            </p>
          </div>
      ...
      <main className="flex-1 px-8 py-6 animate-fade-in">
        <div className="rounded-xl border border-border bg-card shadow-[var(--shadow-sm)] overflow-hidden">
          <img src={img} alt="Cloud Migration & Modernization Coworker — Solution Design" className="w-full h-auto block" />
        </div>
      </main>
    </AppShell>
  );
