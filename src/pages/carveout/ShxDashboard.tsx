...
import dash from "@/assets/shx-dashboard.png";

export default function ShxDashboard() {
    ...
    <AppShell>
        ...
        <div className="px-8 pt-5 pb-4 flex items-start gap-6">
          <div className="flex-1 min-w-0">
            ...
            <h1 className="text-[24px] font-bold tracking-tight text-foreground leading-tight">
              Security Hygiene & Exposure Reduction Coworker — <span className="text-slate-700">Operational Dashboard</span>
            </h1>
            <p className="text-sm text-muted-foreground mt-0.5">
              Live security posture, KPIs, exposure trends, top risky assets, compliance and actions required.
            </p>
          </div>
          <div className="flex items-center gap-2 shrink-0 mt-1">
            ...
            <Button onClick={() => nav("/coworkers/it-carve-out-and-separation/shx/solution-design")} className="h-10 px-4 font-semibold bg-navy hover:bg-navy/90 text-white">
      ...
      <main className="flex-1 px-8 py-6 animate-fade-in">
        <div className="rounded-xl border border-border bg-card shadow-[var(--shadow-sm)] overflow-hidden">
          <img src={dash} alt="Security Hygiene & Exposure Reduction Coworker — Operational Dashboard" className="w-full h-auto block" />
        </div>
      </main>
    </AppShell>
  );
