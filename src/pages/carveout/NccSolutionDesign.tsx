...
import img from "@/assets/ncc-solution-design.png";

export default function NccSolutionDesign() {
    ...
    <AppShell>
        ...
        <div className="px-8 pt-5 pb-4 flex items-start gap-6">
          <div className="flex-1 min-w-0">
            ...
            <h1 className="text-[24px] font-bold tracking-tight text-foreground leading-tight">
              Network Cutover & Connectivity Coworker — <span className="text-slate-700">Solution Design</span>
            </h1>
      ...
      <main className="flex-1 px-8 py-6 animate-fade-in">
        <div className="rounded-xl border border-border bg-card shadow-[var(--shadow-sm)] overflow-hidden">
          <img src={img} alt="Network Cutover & Connectivity Coworker — Solution Design" className="w-full h-auto block" />
        </div>
      </main>
    </AppShell>
  );
