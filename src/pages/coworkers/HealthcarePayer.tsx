        ...
        {cat.items.map((it) => (
          it.to ? (
            ...
            <button
              ...
              aria-disabled="true"
              title="Coming soon"
              className="w-full text-left flex gap-3 items-start rounded-lg border border-dashed border-slate-200 bg-slate-50/60 px-3 py-2.5 shadow-sm opacity-70 cursor-not-allowed"
            >
              <span className="shrink-0 h-6 w-6 rounded-full bg-slate-300 text-white text-[11px] font-bold grid place-items-center mt-0.5">
                {it.n}
              </span>
              <div className="min-w-0 flex-1">
                <div className="flex items-start justify-between gap-2">
                  <div className="text-[12.5px] font-semibold text-slate-500 leading-tight">{it.title}</div>
                  <span className="shrink-0 text-[9.5px] font-bold uppercase tracking-wide text-amber-700 bg-amber-100 border border-amber-200 rounded-full px-1.5 py-0.5 leading-none mt-0.5">
                    Coming soon
                  </span>
                </div>
                <div className="text-[11px] text-slate-400 leading-snug mt-1">{it.desc}</div>
              </div>
            </button>
          )
        ))}
