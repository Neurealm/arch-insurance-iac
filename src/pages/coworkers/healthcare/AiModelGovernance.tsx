...
const config: CoworkerConfig = {
  ...
  center: {
    title: "AI Governance Score — Components (MTD)",
    type: "donut",
    totalLabel: "Score",
    totalValue: "87 / 100",
    segments: [
      { label: "Policy Compliance", value: "96 / 100", pct: 96, color: "#3b82f6" },
      { label: "Risk Management",   value: "84 / 100", pct: 84, color: "#f59e0b" },
      { label: "Transparency",      value: "86 / 100", pct: 86, color: "#a855f7" },
      { label: "Monitoring",        value: "92 / 100", pct: 92, color: "#22c55e" },
      { label: "Accountability",    value: "85 / 100", pct: 85, color: "#ef4444" },
    ],
    bottomTitle: "Governance Score Trend (MTD)",
    bottomCells: [
      { label: "Apr 27", value: "68" },
      { label: "May 4",  value: "72" },
      { label: "May 11", value: "76" },
      { label: "May 18", value: "81" },
      { label: "May 27", value: "87", tone: "pos" },
    ],
  },
  outcomes: {
