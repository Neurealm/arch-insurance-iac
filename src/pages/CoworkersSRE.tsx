      ...
      <main className="flex-1 px-8 py-6 animate-fade-in">
        <div className="flex items-end justify-between mb-5">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">11 specialized SRE coworkers ready to deploy.</p>
          </div>
          <div className="text-xs text-muted-foreground">
            <span className="font-bold text-foreground">11</span> agents · <span className="font-bold text-status-healthy">1</span> deployed
          </div>
        </div>
                  ...
                  <button
                    onClick={() => nav(
                      a.deployed
                        ? "/assurance"
                       : a.num === 5
                       ? "/coworkers/deploy?target=release-deployment-rollout"
                       : a.num === 1
                       ? "/coworkers/deploy?target=slo-sla-sli"
                       : "/coworkers/deploy"
                    )}
