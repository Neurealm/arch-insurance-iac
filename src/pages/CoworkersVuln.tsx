...
import { Plus, ShieldAlert, Bug, ArrowRight, Sparkles } from "lucide-react";
...
const agents: Agent[] = [
  {
    num: 1, tone: "red", icon: Bug,
    name: "Vulnerability / Zero-Day Response Coordination",
    why: "Zero-days and critical CVEs demand coordinated action across security, IT, and application teams within hours — not days.",
    challenge: "Vulnerability data is fragmented across scanners, threat intel, and ticketing systems; prioritization and patch orchestration are manual and slow.",
    how: "Continuously ingests CVE feeds and scanner output, correlates exploitability and asset criticality, opens orchestrated response workflows, and tracks patch SLAs to closure.",
    impact: "Faster mean-time-to-remediate, lower exposure window, fewer breaches, and audit-ready evidence for every critical CVE.",
  },
];
    ...
    <AppShell>
      <header className="bg-card border-b border-border">
        <div className="px-8 pt-5 pb-5 flex items-start gap-6">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-muted-foreground mt-0.5">
              Vulnerability Management — AI teammates that prioritize, coordinate, and close out critical exposures fast.
            </p>
          </div>
        ...
        <div className="px-8 pb-5 grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            { t: "Prioritize by Risk", d: "Exploitability + asset criticality." },
            { t: "Coordinate Response", d: "Cross-team patch orchestration." },
            { t: "Shrink Exposure Window", d: "Hours, not days, to remediate." },
            { t: "Audit Ready", d: "Evidence trail for every CVE." },
          ].map((p) => (
      ...
      <main className="flex-1 px-8 py-6 animate-fade-in">
        <div className="flex items-end justify-between mb-5">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">Specialized vulnerability management coworkers ready to deploy.</p>
          </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between pt-4 mt-4 border-t border-border">
                  ...
                  <button
                    onClick={() => nav("/coworkers/vulnerability-management/zero-day-response")}
