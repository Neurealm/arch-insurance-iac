      ...
      <section className="rounded-md border border-[#E2E8F0] bg-white">
        <div className="flex flex-wrap items-start gap-3 px-4 py-3">
          ...
          <div className="ml-auto flex flex-wrap items-center gap-2">
            ...
            {selectedVm && <Link to={`/remediation/virtual-machines/${encodeURIComponent(selectedVm.name)}`} className="inline-flex h-8 items-center gap-1.5 rounded-md border border-[#1B4F91] bg-[#EFF4FB] px-2.5 text-[12px] font-medium text-[#1B4F91] hover:bg-[#DDEBFA]"><Wrench className="h-3.5 w-3.5" />Assess Operations</Link>}
            {selectedVm && <Link to={`/changes/virtual-machines/${encodeURIComponent(selectedVm.name)}`} className="inline-flex h-8 items-center gap-1.5 rounded-md border border-[#E2E8F0] px-2.5 text-[12px] font-medium text-slate-700 hover:bg-slate-50"><Wrench className="h-3.5 w-3.5" />Build Change Package</Link>}
