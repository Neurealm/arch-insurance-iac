                    ...
                    <div className="flex items-center gap-2 pt-3 mt-3 border-t border-slate-100">
                      <button
                        onClick={() => {
                          ...
                          } else if (a.name === "Host Failure Early Warning") {
                          ...
                          } else if (a.name === "Third-Party Dependency Health") {
                            nav("/coworkers/infrastructure-automation/third-party-dependency-health");
                          }
                        }}
                        className={`flex-1 text-xs font-semibold rounded-lg py-1.5 border ${a.name === "VMware Capacity & Contention" || a.name === "Server Provisioning & Deprovisioning" || a.name === "Host Failure Early Warning" || a.name === "Active Directory Health & Replication" || a.name === "Patch Compliance & Failure Remediation" || a.name === "Time Drift & Kerberos Integrity" || a.name === "Transaction Log & Disk Pressure" || a.name === "Third-Party Dependency Health" ? "border-yellow-400 bg-yellow-300 text-slate-900 hover:bg-yellow-400" : "border-slate-200 bg-white text-slate-700 hover:bg-slate-50"}`}
                      >
                        View Details
                      </button>
