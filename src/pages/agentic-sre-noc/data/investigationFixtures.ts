...
export const causeHypotheses: CauseHypothesis[] = [
  ...
  },
  {
    ...
    components: ["n-partner", "n-fiber", "n-regional", "e-primary"],
...
export const routeSegmentEvidence: RouteSegmentEvidence[] = [
  ...
  { nodeId: "n-fiber", segment: "Fiber handoff", interfaceState: "Up", routingState: "Established", capacity: "20 Gbps", throughput: "8.6 Gbps", latency: "0.6 ms", packetLoss: "0.000 percent", errors: "0", owner: "Coastal Transit Partners", activeChanges: "None", incidents: "None", finding: "Fiber handoff validated at 10:47 UTC.", health: "Healthy" },
