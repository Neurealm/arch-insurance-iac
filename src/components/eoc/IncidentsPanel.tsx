import { incidents, type Incident } from "@/data/eoc";
  ...
  return (
    <section className="bg-card rounded-2xl border border-border p-5 h-full flex flex-col">
      <div className="flex items-center justify-between mb-3">
        <h2 className="text-base font-semibold">Top Active Incidents</h2>
      ...
      <div className="flex items-center justify-between pt-3 mt-2 border-t border-border text-sm">
        ...
        <span className="text-status-critical font-bold text-base">12</span>
      </div>
    </section>
  );
}